...
| Clients, catalogue, stock | Partiel | Modèles existants, CRUD et import à construire |
| Commandes | Partiel | Service de création tenant-scoped; UI et cycle complet à construire |
