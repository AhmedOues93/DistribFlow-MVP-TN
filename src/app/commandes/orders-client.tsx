...
const readableRoles = ["PLATFORM_ADMIN", "OWNER", "ADMIN", "SALES", "WAREHOUSE", "SALES_AGENT", "WAREHOUSE_MANAGER", "ACCOUNTANT", "VIEWER", "READ_ONLY"];
...
export default function OrdersClient() {
  ...
  const canCreate = ["PLATFORM_ADMIN", "OWNER", "ADMIN", "SALES", "SALES_AGENT"].includes(role);
